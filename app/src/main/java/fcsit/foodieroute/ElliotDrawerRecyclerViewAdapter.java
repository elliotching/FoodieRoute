...
public abstract class ElliotDrawerRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ElliotDrawerRecyclerViewAdapter(Context context, int layoutResourceID,//R.layout.custom_drawer_item
